...
export function severityIcState(state) {
  switch (state) {
    case ICState.NO_FEEDBACK       : return MIN_SEVERITY
    case ICState.UNINITIALIZED     : return MIN_SEVERITY
    case ICState.PREMONOMORPHIC    : return MIN_SEVERITY
    case ICState.MONOMORPHIC       : return MIN_SEVERITY
    case ICState.RECOMPUTE_HANDLER : return MIN_SEVERITY
    case ICState.POLYMORPHIC       : return MIN_SEVERITY + 1
    case ICState.MEGAMORPHIC       : return MIN_SEVERITY + 2
    case ICState.GENERIC           : return MIN_SEVERITY + 2
