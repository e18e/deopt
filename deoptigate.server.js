...
import { buildRenderData, serializeRenderData } from './lib/enrich-render-data.js'
...
const indexHtml = new URL('./app/static/index.html', import.meta.url)
const buildDir = new URL('./app/build/', import.meta.url)
